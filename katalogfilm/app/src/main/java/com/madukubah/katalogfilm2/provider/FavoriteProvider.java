        ...
        extends ContentProvider
{
    ...
    static {
        sUriMatcher.addURI(DatabaseContract.AUTHORITY, FavoriteTabel.TABLE_NAME, FAVORITE);
        sUriMatcher.addURI(DatabaseContract.AUTHORITY, FavoriteTabel.TABLE_NAME + "/#", FAVORITE_ID);
    }
