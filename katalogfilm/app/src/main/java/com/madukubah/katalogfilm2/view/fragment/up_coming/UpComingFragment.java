...
public class UpComingFragment
        ...
        implements
            UpComingView.MView
{
    @BindView(R.id.up_coming_toolbar_layout)
    Toolbar toolbar_layout;
    @BindView(R.id.up_coming_rv_movie)
    RecyclerView rv_movie;
    @BindView(R.id.up_coming_progressBar_movie)
    ProgressBar progressBar_movie;
    @BindView(R.id.up_coming_tv_empty)
    TextView tv_empty;
    ...
    public static UpComingFragment create()
    {
    ...
    public void setPresenter(NowPlayingView.Presenter presenter) {
        this.presenter = (UpComingPresenter) presenter;
    }
